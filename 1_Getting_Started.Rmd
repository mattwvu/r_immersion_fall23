...
starWars.data [1, 2] # view specific observation
...
# how people would recommend items from this store

sum(reviews_df$Recommended_IND)

# what is the average rating of items from the store

mean(reviews_df$Rating)

# what is the median number of positive feedback for items from the store
